...
if not os.path.exists(REPO_DIR):
    ...
    run_command(["git", "clone", "--depth", "1", "--no-checkout", REPO_URL, REPO_DIR])
    ...
    only_include_this_content = "/apps/www/content/docs/components/*"
    with open(os.path.join(REPO_DIR, ".git", "info", "sparse-checkout"), "w") as sparse_file:
